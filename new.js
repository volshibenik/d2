...
Person.prototype.talk = function () {
  console.log('I say: ', this.saying, this.age && 'I also am ' + this.age + ' old');
...
function nouveau(constructor, ...args) {
  ...
  return obj
  /* actually, need to return constructor.call(obj, ...args) || obj for edge cases when Person isnt a Constructor */
}
